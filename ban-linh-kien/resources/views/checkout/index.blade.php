...
@section('title', 'Thanh toán - MelMuop')
...
<style>
    ...
    .dark .shipping-notice {
        background: linear-gradient(135deg, #374151, #4b5563);
        border-color: #dc2626;
        color: #f9fafb;
    }
    
    .dark .shipping-notice.free {
        background: linear-gradient(135deg, #065f46, #047857);
        border-color: #10b981;
        color: #ecfdf5;
    }
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="payment-methods">
                                <div class="row g-3">
                                    ...
                                    <!-- VNPay - Available -->
                                    <div class="col-md-6">
                                        <label class="payment-option h-100" data-method="vnpay">
                                            <input type="radio" name="payment_method" value="vnpay">
                                            <div class="d-flex align-items-center h-100">
                                                <div class="payment-icon bg-primary bg-opacity-10 text-primary">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            @php
                                                ...
                                                $imageUrl = $primaryImage ? asset('storage/' . $primaryImage->image_url) : asset('images/placeholder.svg');
                                            @endphp
                                            <img src="{{ $imageUrl }}"
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1 fw-semibold">{{ $item->product->product_name }}</h6>
    ...
    fetch('https://provinces.open-api.vn/api/p/')
        ...
        .then(data => {
            data.forEach(city => {
                ...
                option.value = city.code; // dùng code để load huyện
            ...
            fetch(`https://provinces.open-api.vn/api/p/${cityCode}?depth=2`)
                ...
                .then(data => {
                    data.districts.forEach(district => {
                        const option = document.createElement('option');
                        option.value = district.code; // dùng code để load xã
