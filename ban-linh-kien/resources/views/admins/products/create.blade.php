                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('specifications') is-invalid @enderror" 
                                              id="specifications" name="specifications" rows="4" placeholder='{"cpu": "Intel i7", "ram": "16GB"}'>{{ old('specifications') }}</textarea>
                                    @error('specifications')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Nhập theo định dạng JSON, ví dụ: {"cpu": "Intel i7", "ram": "16GB"}</small>
                                </div>
                            </div>
                        </div>
